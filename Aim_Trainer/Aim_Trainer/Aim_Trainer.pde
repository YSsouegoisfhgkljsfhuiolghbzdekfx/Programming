...
float newx = 0, newy = 0, ogx=random(1,3), ogy=random(0,3), easyTrackHighScore, easySeizeHighScore, easySequenceHighScore, easyCamoHighScore, hardClassicHighScore;
...
void target(int radius, int radiusDifference){
   fill(#FFFFFF);
   circle(x,y,radius); 
   circle(x,y,radius-radiusDifference);
   fill(#161617);
   circle(x,y,radius-(radiusDifference*2));
   circle(x,y,radius-(radiusDifference*3));
   fill(#0081FF);
   circle(x,y,radius-(radiusDifference*4));
   circle(x,y,radius-(radiusDifference*5));
   fill(#FF0100);
   circle(x,y,radius-(radiusDifference*6));
   circle(x,y,radius-(radiusDifference*7));
   fill(#FFFF00);
   circle(x,y,radius-(radiusDifference*8));
   circle(x,y,radius-(radiusDifference*9));
   circle(x,y,radius-(radiusDifference*10));
}

void check(float ex, float why){
      pythagorasA=mouseX-ex;
      pythagorasB=mouseY-why;
...
void draw() {
  ...
  if(hasStarted==1){
    ...
    text("EASY SURVIVAL", width/2-37, height/4+100);
    fill(255,255,0);
    circle(width/3*2,height/4,150);
    text("EASY PERFECT 10s", width/3*2-48, height/4+100);
    fill(255,127,0);
    circle(width/6*5,height/4,150);
    text("EASY FAKE TARGETS", width/6*5-57, height/4+100);
    fill(#FFFFFF);
    circle(width/6*5,height/4*3, 150);
    text("MAIN MENU", width/6*5-38, height/4*3+100);
    fill(255,0,255);
    circle(width/6,height/4*3,150);
    text("EASY MOVING TARGETS", width/6-65, height/4*3+100);
    fill(0,255,255);
    circle(width/3,height/4*3,150);
    text("EASY TARGET TRACKER", width/3-65, height/4*3+100);
    fill(255,0,127);
    circle(width/2,height/4*3,150);
    text("EASY SEIZURE CLASSIC", width/2-67, height/4*3+100);
    fill(0,255,127);
    circle(width/3*2,height/4*3,150);
    text("EASY 2 PLAYER MOVING TARGETS", width/3*2-97, height/4*3+100);
    fill(127,0,255);
    circle(width/6, height/2, 150);
    text("EASY SEQUENCING", width/6-56, height/2+100);
    fill(127,255,0);
    circle(width/3,height/2,150);
    text("EASY FPS", width/3-26, height/2+100);
    fill(127,127,0);
    circle(width/3*2,height/2,150);
    text("EASY DEFENSE",width/3*2-43,height/2+100);
    fill(0,127,127);
    circle(width/6*5,height/2,150);
    text("EASY CAMOUFLAGE",width/6*5-56,height/2+100);
    fill(127,0,127);
    ...
    circle(width/6,height/4,150);
    textSize(15);
    text("HARD CLASSIC", width/6-40, height/4+100);
    fill(0,255,0);
    circle(width/3,height/4,150);
    text("HARD DUEL", width/3-23, height/4+100);
    fill(0,0,255);
    circle(width/2,height/4,150);
    text("HARD SURVIVAL", width/2-37, height/4+100);
    fill(255,127,0);
    circle(width/3*2,height/4,150);
    text("HARD PERFECT 10s", width/3*2-48, height/4+100);
    fill(255,127,0);
    circle(width/6*5,height/4,150);
    text("HARD FAKE TARGETS", width/6*5-56, height/4+100);
    fill(#FFFFFF);
    circle(width/6*5,height/4*3, 150);
    text("MAIN MENU", width/6*5-38, height/4*3+100);
    fill(255,0,255);
    circle(width/6,height/4*3,150);
    text("HARD MOVING TARGETS", width/6-65, height/4*3+100);
    fill(0,255,255);
    circle(width/3,height/4*3,150);
    text("HARD TARGET TRACKER", width/3-65, height/4*3+100);
    fill(255,0,127);
    circle(width/2,height/4*3,150);
    text("HARD SEIZURE CLASSIC", width/2-67, height/4*3+100);
    fill(0,255,127);
    circle(width/3*2,height/4*3,150);
    text("HARD 2 PLAYER MOVING TARGETS", width/3*2-93, height/4*3+100);
    fill(127,0,255);
    circle(width/6, height/2, 150);
    text("HARD SEQUENCING", width/6-56, height/2+100);
    fill(127,255,0);
    circle(width/3,height/2,150);
    text("HARD FPS", width/3-26, height/2+100);
    fill(127,127,0);
    circle(width/3*2,height/2,150);
    text("HARD DEFENSE",width/3*2-43,height/2+100);
    fill(0,127,127);
    circle(width/6*5,height/2,150);
    text("HARD CAMOUFLAGE",width/6*5-56,height/2+100);
    fill(127,0,127);
    text("CPS TEST",width/2-30,height/2+100);
    circle(width/2,height/2,150);
    }
...
text("PRESS 1 TO PLAY AGAIN", 300, 350);
  ...
  if(hasStarted>=3 && gameMode==20 && fakeTimeLoss==true){
   ...
   if(hasStarted==2 && gameMode == 21){
    ...
    if(hasStarted==3 && gameMode == 21 && untrackLoss==false){
    circle(x,y,500);
    basicTimer-=1;
    moveTimer-=1;
    if(moveTimer<=0 || (ogx>2 && ogy>2)){
  ...
  if(hasStarted>=4 && gameMode==21 && untrackLoss == false){
    if(score>easyTrackHighScore){
      easyTrackHighScore=score;
    }
    textSize(20);
    text("You clicked.", 300, 100);
    text("You lose.", 300, 150);
    text("Your score was "+score, 300, 200);
    text("Your high score is "+easyTrackHighScore, 300, 250);
    textSize(30);
    text("PRESS 1 TO PLAY AGAIN", 300, 350);
    text("PRESS 2 TO RETURN TO THE GAME SELECTOR", 300, 400);
    text("PRESS 3 TO RETURN TO THE MAIN MENU", 300, 450);
  ...
  if(hasStarted>=3 && gameMode==21 && untrackLoss==true){
    if(score>easyTrackHighScore){
      easyTrackHighScore=score;
    }
    textSize(20);
  ...
  if((hasStarted>=3)&&(gameMode==22) && basicTimeLoss==false && missLoss==false) {
  ...
  if(hasStarted==2 && gameMode==22){
    ...
    text("Your score is the average score of your shots.", 300, 300);
    text("After the game ends, you will also know the sum of your shots", 300, 350);
    text("The game will end after you take more than 1 second to take a shot or you miss 25 times.", 300, 400);
    text("CLICK TO START", 300, 450);
    textSize(50);
    text("WARNING: FLASHING LIGHTS", 300, 550);
    basicTimer=60;
  ...
  if(hasStarted>=3 && gameMode == 22 && missLoss==true){
    textSize(20);
    if(score>easySeizeHighScore){
      easySeizeHighScore=score;
    }
    text("You missed 25 shots.", 300, 100);
    text("You lose.", 300, 150);
    text("Your average score was "+skill, 300, 200);
    text("Your total score was "+score, 300, 250);
    text("Your high score is "+easySeizeHighScore, 300, 300);
    text("PRESS 1 TO PLAY AGAIN", 300, 450);
    text("PRESS 2 TO RETURN TO THE GAME SELECTOR", 300, 500);
    text("PRESS 3 TO RETURN TO THE MAIN MENU", 300, 550);
   endScreen();
  }
  if(hasStarted>=3&&gameMode == 22 && basicTimeLoss==true){
    if(score>easySeizeHighScore){
      easySeizeHighScore=score;
    }
    textSize(20);
  ...
  if(hasStarted==2 && gameMode==23){
    ...
    if(hasStarted>=3 && gameMode==23 && missLoss==false && score<10 && p2cheat==false && P1duelTimeLoss==false){
  ...
  if(hasStarted>=3 && gameMode==23 && missLoss==true && score<10 && P1duelTimeLoss==false && p2cheat == false){
    textSize(20);
    text("Player 1, you missed the target.", 300, 100);
    text("You lose.", 300, 150);
    text("Player 2 wins.", 300, 200);
  ...
  if(hasStarted>=3 && gameMode==23 && missLoss==false && score<10 && P1duelTimeLoss==true && p2cheat == false){
    textSize(20);
    text("Player 1, you took too long to shoot.", 300, 100);
    text("You lose.", 300, 150);
    text("Player 2 wins.", 300, 200);
  ...
  if(hasStarted>=3 && gameMode==23 && missLoss==false && score<10 && P1duelTimeLoss==false && p2cheat == true){
    textSize(20);
    text("Player 2, you moved the target offscreen.", 300, 100);
    text("You lose.", 300, 150);
    text("Player 1 wins.", 300, 200);
  ...
  if(hasStarted>=3 && gameMode==23 && missLoss==false && score>=10 && P1duelTimeLoss==false && p2cheat == false){
    textSize(20);
    text("Player 1, you hit the target 20 times.", 300, 100);
    text("You win.", 300, 150);
    text("Player 2 loses.", 300, 200);
    text("PRESS 1 TO PLAY AGAIN", 300, 300);
    text("PRESS 2 TO RETURN TO THE GAME SELECTOR", 300, 350);
   ...
   if(hasStarted==2 && gameMode==24){
    textSize(30);
    text("RULES:", 300, 100);
    text("CLICK TO START", 300, 400);
    textSize(20);
    text("There will be 3 targets.", 300, 200);
    text("You must click the red one first, the green one second, and the blue one third.", 300, 250);
    text("You have 2 seconds to click the red target and 1 second to click each subsequent target.", 300, 300);
    basicTimer=120;
    x=random(0,width);
    y=random(0,height);
    newx=random(0,width);
  ...
  if(hasStarted>=3 && gameMode==24 && basicTimeLoss==false){
    basicTimer-=1;
    if(oneGone==false){
     fill(255,0,0);
    circle(x,y,200);
  ...
  if(gameMode==24 && hasStarted>=3 && basicTimeLoss==true){
    textSize(20);
    if(score>easySequenceHighScore){
      easySequenceHighScore=score;
    }
    text("You didn't click the right circle in time.", 300, 100);
    text("You lose.", 300, 150);
    text("Your score was "+score, 300, 200);
    text("You completed "+sequenceScore, 300, 250);
    text("sequences.", 460, 250);
    text("Your high score is "+easySequenceHighScore, 300, 300);
    text("PRESS 1 TO PLAY AGAIN", 300, 400);
    text("PRESS 2 TO RETURN TO THE GAME SELECTOR", 300, 450);
    text("PRESS 3 TO RETURN TO THE MAIN MENU", 300, 500);
    endScreen();
  }
  if(hasStarted==2 && gameMode==26){ 
textSize(30); 
text("RULES:", 300, 100); 
text("CLICK TO START", 300, 450); 
textSize(20); 
text("There will be three targets.", 300, 200); 
text("These targets will advance towards the right edge of the screen.",300,250); 
text("If any of these ever go offscreen or you miss 25 shots, you will lose.", 300, 300); 
text("Whenever you click a target, in addition to gaining points, you will reset its position.", 300, 350); 
x=random(0,width/4); 
...
if(hasStarted>=3 && gameMode==26 && basicTimeLoss==false && missLoss==false){ 
  if(shots>=25){
    missLoss=true;
  }
  fill(#FFFFFF); 
...
} if(x>width+100 || newx>width+100 || newnewx>width+100)
{ 
basicTimeLoss=true; 
} 
if(shots>=25){ 
...
} if(hasStarted>=3 && gameMode==26 && basicTimeLoss==false && missLoss == true)
{ 
  if(score>defenseHighScore){
    defenseHighScore=score;
  }
...
if(hasStarted>=3 && gameMode==26 && basicTimeLoss==true){
  if(score>defenseHighScore){
    defenseHighScore=score;
  }
  textSize(20);
...
text("PRESS 1 TO PLAY AGAIN", 300, 350);
 ...
 if(hasStarted==2 && gameMode == 27){
  textSize(30);
  text("RULES:",300,100);
  text("CLICK TO START",300,400);
  textSize(20);
  text("The target is the same color as the target, but lighter.",300,200);
  text("If you miss 25 shots, you lose.",300,250);
  text("If you don't hit the target in 1 second, you lose.",300,300);
  randomR=random(0,255);
  randomG=random(0,255);
  randomB=random(0,255);
  x=random(0,width);
  ...
  if(hasStarted>=3 && gameMode==27 && basicTimeLoss==false){
    if(basicTimer<0){
      basicTimeLoss=true;
    }
  background(randomR,randomG,randomB);
  fill(randomR+10,randomG+10,randomB+10);
  circle(x,y,200);
  basicTimer-=1;
  if(mousePressed==true){
    check(x,y);
  ...
  if(hasStarted>=3 && gameMode==27 && basicTimeLoss==true){
    if(score>easyCamoHighScore){
      easyCamoHighScore=score;
    }
    textSize(20);
    fill(#FFFFFF);
    text("You took too long to hit the target.",300,100);
    text("You lose.",300,150);
    text("Your score was "+score,300,200);
    text("Your high score is "+easyCamoHighScore,300,250);
    textSize(30);
    text("PRESS 1 TO PLAY AGAIN", 300, 350);
    text("PRESS 2 TO RETURN TO THE GAME SELECTOR", 300, 400);
    text("PRESS 3 TO RETURN TO THE MAIN MENU", 300, 450);
  ...
  if((hasStarted>=3)&&(gameMode==29) && basicTimeLoss==false && missLoss==false) {
  ...
  if(hasStarted>=3&&gameMode==1 && basicTimeLoss==true){
    if(score>hardClassicHighScore){
      hardClassicHighScore=score;
    }
    textSize(20);
    text("You took more than half a second to take a shot.", 300, 100);
    text("You lose.", 300, 150);
    text("Your average score was "+skill, 300, 200);
    text("Your total score was "+score, 300, 250);
    text("Your high score is "+hardClassicHighScore, 300, 300);
    text("PRESS 1 TO PLAY AGAIN", 300, 450);
    text("PRESS 2 TO RETURN TO THE GAME SELECTOR", 300, 500);
    text("PRESS 3 TO RETURN TO THE MAIN MENU", 300, 550);
    endScreen();
...
void mousePressed() {
  ...
  file.play();
  check(width/6,height/4);
  if(pythagorasC<=75){
    gameMode=1;
  }
  else{
    check(width/3,height/4);
    if(pythagorasC<=75){
    gameMode=2;
  }
    else{
      check(width/2,height/4);
      if(pythagorasC<=75){
      gameMode=3;
      }
      else{
       check(width/3*2,height/4);
        if(pythagorasC<=75){
        gameMode=4;
        }
        else{
          check(width/6*5,height/4);
          if(pythagorasC<=75){
            gameMode=5;
            ...
            check(width/6*5,height/4*3);
            if(pythagorasC<=75){
              hasStarted= -1;
            }
            else{
               check(width/6,height/4*3);
               if(pythagorasC<=75){
               gameMode=6;
              }
              else{
                check(width/3,height/4*3);
                if(pythagorasC<=75){
                  gameMode=7;
                 }
                 else{
                  check(width/2,height/4*3);
                  if(pythagorasC<=75){
                    gameMode=8;
                  }
                  else{
                    check(width/3*2,height/4*3);
                    if(pythagorasC<=75){
                      gameMode=9;
                    }
                    else{
                      check(width/6,height/2);
                      if(pythagorasC<=75){
                        gameMode=10;
                      }
                      else{
                       check(width/3,height/2);
                        if(pythagorasC<=75){
                          ...
                          check(width/3*2,height/2);
                          if(pythagorasC<=75){
                            gameMode=13;
                          }
                          else{
                             check(width/6*5,height/2);
                             if(pythagorasC<=75){
                               gameMode=14;
                             }
                             else{
